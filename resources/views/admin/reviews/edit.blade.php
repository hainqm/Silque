...
<div class="container">
    ...
    <form method="post" action="{{route('admin.reviews.update',$reviews->id)}}" >
        @csrf
        @method('PUT')
        <div class="mb-3">
            ...
            value="{{old('ten_nguoi_dung',$reviews->ten_nguoi_dung)}}"
            >
        ...
        <div class="mb-3">
            ...
            value="{{old('ten_san_pham',$reviews->ten_san_pham)}}"
            >
            @error('ten_san_pham')
                <p class="text-danger">{{$message}}</p>
            @enderror
        ...
        <div class="mb-3">
            ...
            >{{old('noi_dung_danh_gia',$reviews->noi_dung_danh_gia)}}</textarea>
        ...
        <button type="submit" class="btn btn-secondary">Update đánh giá</button>
    </form>
